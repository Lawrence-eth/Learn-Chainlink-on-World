          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              ...
              <button
                ...
                className="w-full mt-4 px-4 py-2 bg-indigo-100 text-indigo-900 rounded-lg hover:bg-indigo-200 transition-colors flex items-center justify-center space-x-2"
              >
                <FaChevronLeft />
